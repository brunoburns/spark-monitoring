...
export LOG_ANALYTICS_WORKSPACE_ID=56d2aef1-c1f6-4af0-9fdf-25dd874b418d
export LOG_ANALYTICS_WORKSPACE_KEY=qRZNjTKjk5h1eJ19isFS+Si+RHOpDk+M84okGYutmapePXDHj7HGjSL+7gpqByP7ko585RnYpPL33X4Fjll+LQ==
export AZ_SUBSCRIPTION_ID=fb2927c2-bde4-4887-b16c-6a9b4091d43f
export AZ_RSRC_GRP_NAME=testlogmetrics
export AZ_RSRC_PROV_NAMESPACE=Microsoft.Databricks
export AZ_RSRC_TYPE=workspaces
export AZ_RSRC_NAME=testmetric
